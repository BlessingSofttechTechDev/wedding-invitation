    ...
    <section ref={wrapRef} className="min-h-[105vh] md:min-h-0">
      <div ref={pinRef} className="relative w-full min-h-screen overflow-visible">
        ...
        <div className="relative z-10 flex w-full flex-col items-center justify-start pt-[8vh] md:pt-[12vh] pb-10 md:pb-16 px-6 overflow-visible">
          ...
          <p
            className="font-serif text-base md:text-lg tracking-[0.15em] mb-2"
            style={{ color: palette.accent }}
          >
            आंगन
          </p>
    ...
    <div className="min-h-screen" style={{ backgroundColor: palette.background, color: palette.foreground }}>
      ...
      >
        <div className="max-w-7xl mx-auto px-6 py-8 md:py-16 text-center">
          ...
          <p className="font-serif text-xs mb-4 tracking-[0.12em] font-semibold" style={{ color: palette.accent }}>
            शुभ विवाह
          </p>
